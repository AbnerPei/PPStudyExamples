...
- (void)viewDidLoad {
    ...
    self.isNeedToUpdateWhenUserBrightnessChanged = YES;

    [self setupMaxBrightness:0.8];
}
...
{
    //设置亮度   0.8的亮度差不多了
    [self changeToMaxBrightnessWhenViewDidAppear];
}
//
//页面消失时的方法
...
{
    // 恢复亮度
    [self changeToUserBrightnessWhenViewDidDisappear];
}
